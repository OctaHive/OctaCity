...
pub use model::{
  ...
  MutationDisposition, NormalizedTrigger, RegistrationEpoch,
};
...
mod tests {
  ...
  use super::{
    AppendJobEvents, DurableJobEvent, EventSequence, JobEventKind, LeaseAccess, LeaseFence, MAX_JOB_EVENT_BATCH_SIZE,
    MAX_JOB_EVENT_PAYLOAD_BYTES, RegistrationEpoch, StoreError, StoreInputError, StoreOperation,
  };
