...
pub async fn seed_authoritative_prerequisites(
  ...
  sqlx::query(
    "INSERT INTO pools \
     ...
     VALUES \
       ($1, 1, 'contract-allowed', true, 'accepting', '{}', 4, now()), \
       ($2, 1, 'contract-other', true, 'accepting', '{}', 4, now()), \
       ($3, 1, 'contract-disabled', false, 'accepting', '{}', 4, now()), \
       ($4, 1, 'contract-draining', true, 'draining', '{}', 4, now())",
  )
  ...
  sqlx::query(
    "INSERT INTO agents \
     ...
     VALUES \
       ($1, 'contract-agent', $2, 1, 'online', '{}', 1, now(), now()), \
       ($3, 'contract-other-agent', $4, 1, 'online', '{}', 1, now(), now()), \
       ($5, 'contract-disabled-agent', $6, 1, 'online', '{}', 1, now(), now()), \
       ($7, 'contract-draining-agent', $8, 1, 'online', '{}', 1, now(), now()), \
       ($9, 'contract-expired-agent', $2, 1, 'online', '{}', 1, now(), now()), \
       ($10, 'contract-revoked-agent', $2, 1, 'online', '{}', 1, now(), now())",
  )
  ...
  sqlx::query(
    "INSERT INTO agent_registrations \
     ...
     VALUES \
       ($1, $2, $3, decode(repeat('01', 32), 'hex'), '{}', to_timestamp(0), '9999-12-31 23:59:59+00', NULL), \
       ($4, $5, $3, decode(repeat('02', 32), 'hex'), '{}', to_timestamp(0), '9999-12-31 23:59:59+00', NULL), \
       ($6, $7, $3, decode(repeat('03', 32), 'hex'), '{}', to_timestamp(0), '9999-12-31 23:59:59+00', NULL), \
       ($8, $9, $3, decode(repeat('04', 32), 'hex'), '{}', to_timestamp(0), '9999-12-31 23:59:59+00', NULL), \
       ($10, $11, $3, decode(repeat('05', 32), 'hex'), '{}', to_timestamp(0), to_timestamp(1), NULL), \
       ($12, $13, $3, decode(repeat('06', 32), 'hex'), '{}', to_timestamp(0), '9999-12-31 23:59:59+00', to_timestamp(0))",
  )
