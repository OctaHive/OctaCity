//! Discovers trusted VCS adapters and supervises their processes.
//!
...
//! protocol frames, so repository credentials remain behind opaque handles.
...
pub use host::{HostFailureClass, VcsHostError};
pub use registry::{InstalledVcsAdapter, RegistryError, VcsAdapterRegistry};
