...
fn golden_coordinator_documents_match_the_wire_types() {
  let registration: RegisterAgentRequest = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/register-request-v1.json"
  ))
  .unwrap();
  ...
  let heartbeat: HeartbeatRequest = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/heartbeat-request-v1.json"
  ))
  .unwrap();
  ...
  let heartbeat: HeartbeatResponse = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/heartbeat-response-v1.json"
  ))
  .unwrap();
  ...
  let upload_complete: CompleteOutputUploadRequest = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/output-complete-request-v1.json"
  ))
  .unwrap();
  upload_complete.validate().unwrap();

  let upload_complete_response: CompleteOutputUploadResponse = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/output-complete-response-v1.json"
  ))
  .unwrap();
  ...
  let cache: BeginCacheSessionRequest = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/cache-begin-request-v1.json"
  ))
  .unwrap();
  cache.validate().unwrap();

  let cache_response: BeginCacheSessionResponse = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/cache-begin-response-v1.json"
  ))
  .unwrap();
  cache_response
  ...
  let cache_revoke: RevokeCacheSessionRequest = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/cache-revoke-request-v1.json"
  ))
  .unwrap();
  cache_revoke.validate().unwrap();

  let cache_revoke_response: RevokeCacheSessionResponse = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/cache-revoke-response-v1.json"
  ))
  .unwrap();
  ...
  let completion: CompleteLeaseRequest = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/complete-request-v1.json"
  ))
  .unwrap();
  completion.validate().unwrap();

  let completion_response: CompleteLeaseResponse = serde_json::from_str(include_str!(
    "../../../protocol-fixtures/coordinator/complete-response-v1.json"
  ))
  .unwrap();
  completion_response
