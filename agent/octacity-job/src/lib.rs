...
//!
//! This crate implements the Agent-side **Executor** role. It accepts an
...
//! process, microVM, and transport mechanics remain behind their respective
//! interfaces. The server-side Orchestrator never performs this work.
//!
